...
namespace ToDoList.Tests
{
  ...
  public class ItemTests
  {
    ...
    public void SetDescription_SetDescription_String()
    {
      ...
      string updatedDescription = "Do the dishes"; //(Arrange)
      newItem.Description = updatedDescription; //(Arrange)
      string result = newItem.Description;  //set string to result of getting the Description property of newItem (Act)

      Assert.AreEqual(updatedDescription, result); //make sure description retrieved from the Item object matches the description string (Assert)
    }
  }
}